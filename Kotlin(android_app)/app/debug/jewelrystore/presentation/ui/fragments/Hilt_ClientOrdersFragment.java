...
public abstract class Hilt_ClientOrdersFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ClientOrdersFragment() {
    super();
  }

  Hilt_ClientOrdersFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ClientOrdersFragment_GeneratedInjector) this.generatedComponent()).injectClientOrdersFragment(UnsafeCasts.<ClientOrdersFragment>unsafeCast(this));
    }
  }
