...
public abstract class Hilt_ModeratorProductsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ModeratorProductsFragment() {
    super();
  }

  Hilt_ModeratorProductsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ModeratorProductsFragment_GeneratedInjector) this.generatedComponent()).injectModeratorProductsFragment(UnsafeCasts.<ModeratorProductsFragment>unsafeCast(this));
    }
  }
