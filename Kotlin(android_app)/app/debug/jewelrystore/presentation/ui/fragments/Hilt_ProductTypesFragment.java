...
public abstract class Hilt_ProductTypesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductTypesFragment() {
    super();
  }

  Hilt_ProductTypesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductTypesFragment_GeneratedInjector) this.generatedComponent()).injectProductTypesFragment(UnsafeCasts.<ProductTypesFragment>unsafeCast(this));
    }
  }
