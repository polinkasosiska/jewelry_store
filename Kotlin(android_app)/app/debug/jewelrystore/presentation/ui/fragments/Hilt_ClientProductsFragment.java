...
public abstract class Hilt_ClientProductsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ClientProductsFragment() {
    super();
  }

  Hilt_ClientProductsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ClientProductsFragment_GeneratedInjector) this.generatedComponent()).injectClientProductsFragment(UnsafeCasts.<ClientProductsFragment>unsafeCast(this));
    }
  }
