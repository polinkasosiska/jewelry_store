...
public abstract class Hilt_ModeratorOrdersFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ModeratorOrdersFragment() {
    super();
  }

  Hilt_ModeratorOrdersFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ModeratorOrdersFragment_GeneratedInjector) this.generatedComponent()).injectModeratorOrdersFragment(UnsafeCasts.<ModeratorOrdersFragment>unsafeCast(this));
    }
  }
