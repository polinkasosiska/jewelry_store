...
public abstract class Hilt_AddProductTypeDialogFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddProductTypeDialogFragment() {
    super();
  }

  Hilt_AddProductTypeDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddProductTypeDialogFragment_GeneratedInjector) this.generatedComponent()).injectAddProductTypeDialogFragment(UnsafeCasts.<AddProductTypeDialogFragment>unsafeCast(this));
    }
  }
