...
public abstract class Hilt_AddProductDialogFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddProductDialogFragment() {
    super();
  }

  Hilt_AddProductDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddProductDialogFragment_GeneratedInjector) this.generatedComponent()).injectAddProductDialogFragment(UnsafeCasts.<AddProductDialogFragment>unsafeCast(this));
    }
  }
