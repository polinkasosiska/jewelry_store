...
public abstract class Hilt_AddCartItemDialogFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddCartItemDialogFragment() {
    super();
  }

  Hilt_AddCartItemDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddCartItemDialogFragment_GeneratedInjector) this.generatedComponent()).injectAddCartItemDialogFragment(UnsafeCasts.<AddCartItemDialogFragment>unsafeCast(this));
    }
  }
