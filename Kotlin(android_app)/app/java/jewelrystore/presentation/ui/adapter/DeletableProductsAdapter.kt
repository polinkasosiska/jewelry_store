...
class DeletableProductsAdapter(private val listener: (Int) -> Unit) :
    RecyclerView.Adapter<DeletableProductsAdapter.CourseViewHolder>() {
    ...
    inner class CourseViewHolder(val binding: ItemProductBinding) :
