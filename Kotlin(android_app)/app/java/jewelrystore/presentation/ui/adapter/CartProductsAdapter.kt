...
import com.sysoliatina.jewelrystore.databinding.ItemCartProductBinding
import com.sysoliatina.jewelrystore.databinding.ItemProductBinding
import com.sysoliatina.jewelrystore.models.Product


class CartProductsAdapter(private val listener: (Int) -> Unit) :
    RecyclerView.Adapter<CartProductsAdapter.CourseViewHolder>() {
    ...
    inner class CourseViewHolder(val binding: ItemCartProductBinding) :
